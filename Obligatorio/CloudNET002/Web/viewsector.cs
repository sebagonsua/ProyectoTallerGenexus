...
namespace GeneXus.Programs {
   public class viewsector : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewSector");
         forbiddenHiddens.Add("SectorNombre", StringUtil.RTrim( context.localUtil.Format( A11SectorNombre, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewsector:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Sectors", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewSector.htm");
            ...
            GxWebStd.gx_label_element( context, edtSectorNombre_Internalname, "Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtSectorNombre_Internalname, StringUtil.RTrim( A11SectorNombre), StringUtil.RTrim( context.localUtil.Format( A11SectorNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSectorNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtSectorNombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_ViewSector.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF042( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A5SectorId = H00042_A5SectorId[0];
               A11SectorNombre = H00042_A11SectorNombre[0];
      ...
      protected void STRUP040( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLogError("viewsector:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11042( )
      {
         ...
         {
            A5SectorId = H00043_A5SectorId[0];
            A11SectorNombre = H00043_A11SectorNombre[0];
            AssignAttri("", false, "A11SectorNombre", A11SectorNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A11SectorNombre;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202573118385064", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewsector.js", "?202573118385064", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12SectorId","fld":"vSECTORID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A11SectorNombre","fld":"SECTORNOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00042_A5SectorId = new short[1] ;
         H00042_A11SectorNombre = new string[] {""} ;
         hsh = "";
         H00043_A5SectorId = new short[1] ;
         H00043_A11SectorNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewsector__default(),
            new Object[][] {
                new Object[] {
               H00042_A5SectorId, H00042_A11SectorNombre
               }
               , new Object[] {
               H00043_A5SectorId, H00043_A11SectorNombre
               }
            }
         );
      ...
      private short[] H00042_A5SectorId ;
      private string[] H00042_A11SectorNombre ;
      private short[] H00043_A5SectorId ;
      private string[] H00043_A11SectorNombre ;
   ...
   public class viewsector__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00042", "SELECT [SectorId], [SectorNombre] FROM [Sector] WHERE [SectorId] = @AV12SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00042,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00043", "SELECT [SectorId], [SectorNombre] FROM [Sector] WHERE [SectorId] = @AV12SectorId ORDER BY [SectorId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00043,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
