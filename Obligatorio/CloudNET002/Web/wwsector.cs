...
namespace GeneXus.Programs {
   public class wwsector : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11SectorNombre = GetPar( "SectorNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11SectorNombre, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSECTORNOMBRE", StringUtil.RTrim( AV11SectorNombre));
         /* Send saved values. */
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Sectors", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWSector.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWSector.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavSectornombre_Internalname, "Sector Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSectornombre_Internalname, StringUtil.RTrim( AV11SectorNombre), StringUtil.RTrim( context.localUtil.Format( AV11SectorNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavSectornombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavSectornombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWSector.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START052( )
      {
         ...
         Form.Meta.addItem("description", "Sectors", 0) ;
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Sectornombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vSECTORNOMBRE"), AV11SectorNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA052( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavSectornombre_Internalname;
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11SectorNombre = StringUtil.PadR( StringUtil.RTrim( AV11SectorNombre), 50, "%");
            /* Using cursor H00052 */
            pr_default.execute(0, new Object[] {lV11SectorNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A11SectorNombre = H00052_A11SectorNombre[0];
               A7Habilitado = H00052_A7Habilitado[0];
               A6CantidadAsientos = H00052_A6CantidadAsientos[0];
               A5SectorId = H00052_A5SectorId[0];
               /* Execute user event: Grid.Load */
               E14052 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SECTORID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A5SectorId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11SectorNombre = StringUtil.PadR( StringUtil.RTrim( AV11SectorNombre), 50, "%");
         /* Using cursor H00053 */
         pr_default.execute(1, new Object[] {lV11SectorNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11SectorNombre = GridState.FilterValues("Sectornombre");
            AssignAttri("", false, "AV11SectorNombre", AV11SectorNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("SectorNombre", AV11SectorNombre);
      }
      ...
      protected void STRUP050( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11SectorNombre = cgiGet( edtavSectornombre_Internalname);
            AssignAttri("", false, "AV11SectorNombre", AV11SectorNombre);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202573118385095", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwsector.js", "?202573118385095", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtCantidadAsientos_Internalname = "CANTIDADASIENTOS_"+sGXsfl_27_idx;
         chkHabilitado_Internalname = "HABILITADO_"+sGXsfl_27_idx;
         edtSectorNombre_Internalname = "SECTORNOMBRE_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtCantidadAsientos_Internalname = "CANTIDADASIENTOS_"+sGXsfl_27_fel_idx;
         chkHabilitado_Internalname = "HABILITADO_"+sGXsfl_27_fel_idx;
         edtSectorNombre_Internalname = "SECTORNOMBRE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCantidadAsientos_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A6CantidadAsientos), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A6CantidadAsientos), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCantidadAsientos_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "HABILITADO_" + sGXsfl_27_idx;
            chkHabilitado.Name = GXCCtl;
            chkHabilitado.WebTags = "";
            chkHabilitado.Caption = "";
            AssignProp("", false, chkHabilitado_Internalname, "TitleCaption", chkHabilitado.Caption, !bGXsfl_27_Refreshing);
            chkHabilitado.CheckedValue = "false";
            A7Habilitado = StringUtil.StrToBool( StringUtil.BoolToStr( A7Habilitado));
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkHabilitado_Internalname,StringUtil.BoolToStr( A7Habilitado),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"column column-optional",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl27( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Asientos") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Habilitado") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A6CantidadAsientos), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( A7Habilitado)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A11SectorNombre)));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavSectornombre_Internalname = "vSECTORNOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtCantidadAsientos_Enabled = 0;
         edtSectorId_Enabled = 0;
         edtavSectornombre_Jsonclick = "";
         edtavSectornombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SectorNombre","fld":"vSECTORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E14052","iparms":[{"av":"A5SectorId","fld":"SECTORID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E11052","iparms":[{"av":"A5SectorId","fld":"SECTORID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SectorNombre","fld":"vSECTORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SectorNombre","fld":"vSECTORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SectorNombre","fld":"vSECTORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11SectorNombre","fld":"vSECTORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11SectorNombre = "";
         H00052_A11SectorNombre = new string[] {""} ;
         H00052_A7Habilitado = new bool[] {false} ;
         H00052_A6CantidadAsientos = new short[1] ;
         H00052_A5SectorId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwsector__default(),
            new Object[][] {
                new Object[] {
               H00052_A11SectorNombre, H00052_A7Habilitado, H00052_A6CantidadAsientos, H00052_A5SectorId
               }
               , new Object[] {
      ...
      private int edtavSectornombre_Enabled ;
      ...
      private string edtavSectornombre_Internalname ;
      private string edtavSectornombre_Jsonclick ;
      ...
      private string[] H00052_A11SectorNombre ;
      private bool[] H00052_A7Habilitado ;
      private short[] H00052_A6CantidadAsientos ;
      private short[] H00052_A5SectorId ;
   ...
   public class wwsector__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A11SectorNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [SectorNombre], [Habilitado], [CantidadAsientos], [SectorId]";
         ...
         sOrderString += " ORDER BY [SectorNombre]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11SectorNombre",GXType.NChar,50,0) ,
