...
namespace GeneXus.Programs {
   public class pais : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtPaisId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A3PaisId), 4, 0, ".", "")), StringUtil.LTrim( ((edtPaisId_Enabled!=0) ? context.localUtil.Format( (decimal)(A3PaisId), "ZZZ9") : context.localUtil.Format( (decimal)(A3PaisId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaisId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Pais.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, StringUtil.RTrim( A4PaisNombre), StringUtil.RTrim( context.localUtil.Format( A4PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "Nombre", "start", true, "", "HLP_Pais.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z3PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "Z3PaisId"), ".", ","), 18, MidpointRounding.ToEven));
            Z4PaisNombre = cgiGet( "Z4PaisNombre");
            ...
            AssignAttri("", false, "A4PaisNombre", A4PaisNombre);
         ...
         else
         {
            ...
            if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               A3PaisId = (short)(Math.Round(NumberUtil.Val( GetPar( "PaisId"), "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A3PaisId", StringUtil.LTrimStr( (decimal)(A3PaisId), 4, 0));
               getEqualNoModal( ) ;
               Gx_mode = "DSP";
               AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void ZM033( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z4PaisNombre = T00033_A4PaisNombre[0];
            }
            else
            {
      ...
      protected void Load033( )
      {
         ...
         {
            RcdFound3 = 1;
            A4PaisNombre = T00034_A4PaisNombre[0];
            AssignAttri("", false, "A4PaisNombre", A4PaisNombre);
            ZM033( -1) ;
         }
         pr_default.close(2);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A3PaisId", StringUtil.LTrimStr( (decimal)(A3PaisId), 4, 0));
            A4PaisNombre = T00033_A4PaisNombre[0];
            AssignAttri("", false, "A4PaisNombre", A4PaisNombre);
            Z3PaisId = A3PaisId;
            sMode3 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void CheckOptimisticConcurrency033( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z4PaisNombre, T00032_A4PaisNombre[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z4PaisNombre, T00032_A4PaisNombre[0]) != 0 )
               {
                  GXUtil.WriteLog("pais:[seudo value changed for attri]"+"PaisNombre");
                  GXUtil.WriteLogRaw("Old: ",Z4PaisNombre);
                  GXUtil.WriteLogRaw("Current: ",T00032_A4PaisNombre[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00038 */
                     pr_default.execute(6, new Object[] {A3PaisId, A4PaisNombre});
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00039 */
                     pr_default.execute(7, new Object[] {A4PaisNombre, A3PaisId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Pais");
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z4PaisNombre", StringUtil.RTrim( Z4PaisNombre));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202573118385628", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pais.js", "?202573118385628", false, true);
      ...
      public void Valid_Paisid( )
      {
         ...
         AssignAttri("", false, "A4PaisNombre", StringUtil.RTrim( A4PaisNombre));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_PAISID","""{"handler":"Valid_Paisid","iparms":[{"av":"A3PaisId","fld":"PAISID","pic":"ZZZ9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         setEventMetadata("VALID_PAISID",""","oparms":[{"av":"A4PaisNombre","fld":"PAISNOMBRE"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z3PaisId"},{"av":"Z4PaisNombre"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pais__default(),
            new Object[][] {
                new Object[] {
               T00032_A3PaisId, T00032_A4PaisNombre
               }
               , new Object[] {
               T00033_A3PaisId, T00033_A4PaisNombre
               }
               , new Object[] {
               T00034_A3PaisId, T00034_A4PaisNombre
               }
               , new Object[] {
               T00035_A3PaisId
               }
   ...
   public class pais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@PaisId",GXType.Int16,4,0) ,
          new ParDef("@PaisNombre",GXType.NChar,50,0)
          };
          Object[] prmT00039;
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("T00038", "INSERT INTO [Pais]([PaisId], [PaisNombre]) VALUES(@PaisId, @PaisNombre)", GxErrorMask.GX_NOMASK,prmT00038)
             ...
             ,new CursorDef("T000311", "SELECT [PaisId] FROM [Pais] ORDER BY [PaisId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000311,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
